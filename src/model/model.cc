...
void Model::fillListPdfBin(QListWidget *listPdf, QListWidget *listBin, QString deviceName, QString processName) {
    QSqlQuery queryPdf;
    queryPdf.prepare(
        "SELECT f.name \
                        from data \
...
void Model::insertFilesToData(QString deviceName, QString processName, QString fileName){
